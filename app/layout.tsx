...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Website erstellen lassen Siegen",
    "Webagentur Siegen",
    "Internetagentur Siegen",
    "WordPress Agentur Siegen",
    "Website herrichten lassen Siegen",
    "Homepage optimieren Siegen",
    "Website Relaunch Agentur Siegen",
    "Webdesign Kreis Olpe",
    "Webdesign Kreuztal",
    "Webdesign Netphen",
    "Webdesign Wilnsdorf",
    ...
    "Full Stack Webentwickler mieten",
    "Next.js Entwickler Freelancer",
    "React Webseite erstellen",
    "B2B Online Shop entwickeln",
    "Website schneller machen lassen",
    "Core Web Vitals optimieren Agentur",
    "Page Speed Optimierung Freelancer",
    "Website Audit durchführen lassen",
    // KI & Automatisierung
    "KI Feature auf Website integrieren",
    "ChatGPT auf eigener Homepage einbinden",
    "KI Automatisierung für Unternehmen",
    "AI Automation Agency Deutschland",
    "KI Entwickler Freelancer",
    "Kundenservice automatisieren KI",
    "KI Chatbot für Website erstellen",
    "Prozesse automatisieren Software",
    "KI-gestützte Leadgenerierung Website",
    "automatisierte Angebotserstellung Software",
    // Kaufabsicht
    "was kostet eine professionelle Website",
    "Webdesigner Siegen Preise",
    "Angebot Websiteerstellung anfordern",
    "KI Automatisierung Unternehmen Kosten",
  ],
