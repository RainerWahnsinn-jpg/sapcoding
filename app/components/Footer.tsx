    ...
    <footer className="border-t border-white/10 bg-black py-12">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-6 text-sm text-white/60 sm:flex-row">
        <div className="text-center sm:text-left">
          <p className="text-white/80">Maßgeschneiderte Webentwicklung & KI-Tools.</p>
          <p className="mt-2 text-white/50">© 2026 Constantin Weib</p>
          <p className="mt-2 text-white/50">📍 Entwickelt mit Herzblut in Siegen, Südwestfalen.</p>
        </div>
